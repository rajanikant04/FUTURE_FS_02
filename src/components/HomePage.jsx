    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <section className="relative bg-gradient-to-br from-gray-800 via-gray-900 to-black text-white overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-32 right-20 w-16 h-16 bg-gray-300 opacity-20 rounded-full animate-luxuryPulse"></div>
          <div className="absolute bottom-20 left-1/4 w-12 h-12 bg-gray-400 opacity-15 rounded-full animate-float animate-delay-300"></div>
          <div className="absolute bottom-32 right-1/3 w-24 h-24 bg-gray-500 opacity-10 rounded-full animate-luxuryPulse animate-delay-500"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl lg:text-3xl mb-8 text-gray-200 max-w-4xl mx-auto animate-fadeInUp animate-delay-200 font-light leading-relaxed">
      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 animate-fadeInUp">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-gray-100 mb-4 text-gradient">Why Choose Snitch?</h2>
            <p className="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mx-auto font-light leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div className="w-20 h-20 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-600 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:from-gray-200 group-hover:to-gray-300 dark:group-hover:from-gray-600 dark:group-hover:to-gray-500 transition-all duration-300 group-hover:rotate-6 group-hover:scale-110">
                  <feature.icon className="h-10 w-10 text-gray-700 dark:text-gray-300 group-hover:scale-110 transition-transform duration-300" />
                </div>
                <h3 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-3 group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors duration-300">{feature.title}</h3>
      ...
      <section className="py-16 bg-white dark:bg-gray-900 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-transparent via-gray-50/30 to-gray-100/30 dark:via-gray-800/30 dark:to-gray-700/30"></div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 animate-fadeInUp">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-gray-100 mb-4 text-gradient">Shop by Category</h2>
            <p className="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mx-auto font-light leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {featuredCategories.map((category, index) => (
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2 group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors duration-300">{category.name}</h3>
      ...
      <section className="py-16 bg-gray-900 text-white relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-10 right-10 w-32 h-32 bg-gray-600/20 rounded-full animate-pulse"></div>
          <div className="absolute bottom-20 left-10 w-24 h-24 bg-gray-700/20 rounded-full animate-pulse animation-delay-300"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-gray-600/10 to-gray-700/10 rounded-full animate-pulse animation-delay-500"></div>
        </div>
