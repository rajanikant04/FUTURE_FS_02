      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm">Men's Clothing</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm">Women's Clothing</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm">Accessories</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm">Footwear</a></li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300 text-sm">123 Fashion Avenue, Style City, FC 12345</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="h-4 w-4 text-pink-400 flex-shrink-0" />
                <span className="text-gray-300 text-sm">+1 (555) 123-STYLE</span>
              </div>
              <div className="flex items-center space-x-3">
            ...
            <div className="mt-6">
              ...
              <div className="flex">
                <input
                  ...
                  className="flex-1 px-3 py-2 bg-gray-800 border border-gray-700 rounded-l-md text-sm focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex items-center justify-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-xs">On orders over ₹3,000</p>
              </div>
            </div>
            <div className="flex items-center justify-center space-x-3">
