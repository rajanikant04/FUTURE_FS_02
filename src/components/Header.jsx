  ...
  return (
    <header className="bg-white/95 backdrop-blur-lg shadow-lg sticky top-0 z-40 animate-slideInFromBottom border-b border-white/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-gray-200 bg-white animate-slideInFromBottom">
            <div className="px-4 py-4 space-y-4">
              ...
              <div className="flex flex-col space-y-2">
                <button
                  ...
                  className={`px-4 py-3 rounded-lg font-medium transition-all duration-300 text-left transform hover:scale-105 ${
                    currentPage === 'home'
                      ? 'text-pink-600 bg-pink-50 border border-pink-200 shadow-md'
              ...
              <div className="flex flex-col space-y-2">
                <button 
                  ...
                  className="w-full px-4 py-3 text-gray-600 hover:text-pink-600 font-medium transition-all duration-300 text-left border border-gray-300 rounded-lg hover:border-pink-300 transform hover:scale-105"
                >
